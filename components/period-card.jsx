...
import { format, addDays, isBefore, isSameDay, isWithinInterval } from "date-fns";
    ...
    <Card className={cn(
      ...
      <CardContent className="pt-4">
        <div className="space-y-4">
          ...
          {periodEntry.conditions && periodEntry.conditions.length > 0 && periodEntry.conditions[0] !== "none" && (
            <div className="space-y-1">
